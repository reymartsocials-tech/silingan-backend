...
-- ---------------------------------------------------------------------
-- Sample tenants, communities, users and issues for local development and
-- manual testing.
--
...
-- every start; re-running must be a no-op and must never clobber data a
-- developer has changed locally.
-- =====================================================================
...
INSERT INTO users (
    id, keycloak_user_id, username, email, first_name, last_name, created_at, updated_at, deleted
) VALUES
    ('30000000-0000-0000-0000-000000000001', 'kc-platform-admin-001', 'platform_admin', 'admin@silingan.local', 'Platform', 'Admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
    ('30000000-0000-0000-0000-000000000002', 'kc-resident-001', NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
    ('30000000-0000-0000-0000-000000000003', 'kc-resident-002', NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
    ('30000000-0000-0000-0000-000000000004', '9d248a49-e614-4d86-81ba-3b473fb7831e', NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE)
ON CONFLICT DO NOTHING;

INSERT INTO user_communities (
    id, user_id, community_id, role, active, joined_at
) VALUES
    ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'PLATFORM_ADMIN', TRUE, CURRENT_TIMESTAMP),
    ('40000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', 'COMMUNITY_ADMIN', TRUE, CURRENT_TIMESTAMP),
    ('40000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000002', 'RESIDENT', TRUE, CURRENT_TIMESTAMP)
ON CONFLICT DO NOTHING;
